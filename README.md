...
- **Notifications**
    - [Get notifications](https://github.com/hel-sidoruk/rs-clone-server#get-notifications)
    - [Add notification](https://github.com/hel-sidoruk/rs-clone-server#add-notification)
    - [Delete notification](https://github.com/hel-sidoruk/rs-clone-server#delete-notification)
